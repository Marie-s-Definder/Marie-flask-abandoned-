...
def boxdraw(img, location, status, text):
    ...
    org = (start_point[0], start_point[1] - 10)  # 文本左下角坐标

    # 定义字体和字号
    font = cv2.FONT_HERSHEY_SIMPLEX
    font_scale = 0.5
    # 定义文本颜色
    text_color = (0, 255, 0)  # 绿色，格式为 (blue, green, red)
    # 定义文本粗细
    thickness = 2
    # 在图像上绘制文本
    image_with_text = cv2.putText(image_with_rectangle, text, org, font, font_scale, text_color, thickness)
