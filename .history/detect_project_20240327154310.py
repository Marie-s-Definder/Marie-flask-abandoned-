...
model = YOLO('D:/CODE/ob_dec/yolov8/yolov8m.pt')  # load a pretrained model (recommended for training)
# model = YOLO('/root/autodl-tmp/yolov8/ultralytics/models/v8/yolov8m-enhance.yaml').load('/root/autodl-tmp/yolov8/yolov8m.pt')
# Use the model
detections = model.predict(source="D:/CODE/ob_dec/yolov8/datasets/exdark/test/images/2015_01081.jpg", save=True)  # train the model
print('yes')
